...
public class ElectricComplaint {
    ...
    public int priority;
    public ElectricComplaint(String complaintNum, String complaintType, String complaintFrom, String complaintTo, String complaintRoom, int priority, String ComplaintDescription) {
